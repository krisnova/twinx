...
func (c *ConnServer) messageCommandPublishResponse(cur *ChunkStream) error {
	...
	return c.writeMsg(cur.CSID, cur.StreamID, CommandTypeOnStatus, 0, nil, event)
}
...
func (c *ConnServer) messageCommandPlayResponse(cur *ChunkStream) error {
	...
	if err := c.writeMsg(cur.CSID, cur.StreamID, CommandTypeOnStatus, 0, nil, event); err != nil {
		return err
	}
